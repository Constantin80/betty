                        ...
                        if (accountAPINGException != null) {
                            switch (accountAPINGException.getErrorCode()) {
                                case INVALID_SESSION_INFORMATION:
                                    ...
                                    Generic.alreadyPrintedMap.logOnce(defaultPrintExpiry, logger, LogLevel.INFO, "needing another session token, call to api-ng failed: {} {}", httpEntityString, statusLine);
