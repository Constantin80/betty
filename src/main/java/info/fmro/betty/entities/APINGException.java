...
public class APINGException
    ...
    public APINGException(String errorDetails, APINGExceptionErrorCode errorCode, String requestUUID) {
        super((Throwable) null);
    ...
    public synchronized void setErrorCode(APINGExceptionErrorCode errorCode) {
        this.errorCode = errorCode;
    }
