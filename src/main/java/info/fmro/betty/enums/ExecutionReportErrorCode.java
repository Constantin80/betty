...
public enum ExecutionReportErrorCode {
    ...
    INVALID_ORDER("Order cannot be accepted by the matcher due to the combination of actions. For example, bets being edited are not on the same market, " +
            "or order includes both edits and placement"),
